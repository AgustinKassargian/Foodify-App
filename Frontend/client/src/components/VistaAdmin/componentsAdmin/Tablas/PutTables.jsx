...
function EditTable() {
  ...
  return (
    ...
    <div className='grid justify-items-center items-center content-center mt-28'>
      <div>
        <div className='border border-gray-300 rounded-lg bg-primary'>
          <div>
            <h1 className="sm: w-full flex justify-center outline-none text-lg p-2 rounded  bg-gray-50 order-b-4 border-gray-300">Edit Table</h1>
          </div>
          <div className='mt-[10px] flex justify-center'>
            <button onClick={handleLoad} class="inline-flex items-center py-2 px-4 text-sm font-medium text-gray-500 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 mt-4 mb-4">Load current table</button>
          </div>
