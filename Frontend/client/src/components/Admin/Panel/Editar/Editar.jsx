...
//   const categories = ['Starter', 'Main Dish', 'Drink', 'Dessert', 'Veggie', 'Vegan', 'Pasta', 'Salad', 'Meat', 'Take Away']
...
//         <div>
//         <div>
//                 <h1 className="sm: w-full flex justify-center outline-none text-lg p-2 rounded  bg-orange-300">Edit Menu</h1>
//               </div>
//             <div>
//               <button onClick={handleLoad}>Cargar Menu seleccionado</button>
//             </div>
