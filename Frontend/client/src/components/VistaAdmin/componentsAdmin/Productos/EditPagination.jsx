export default function Pagination({paginated, dishes, dishesPerPage, currentPage}){

    let pageNumber = []

    for(let i = 1; i < Math.ceil(dishes / dishesPerPage); i++) {
        pageNumber.push(i)
    }
...
return (
    <div>
        <nav>
            ...
            { currentPage < dishes / dishesPerPage ? (
                <li onClick={() => paginated(currentPage + 1)}>
